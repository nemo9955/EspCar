...
L298N::L298N(uint8_t pinEnable, uint8_t pinIN1, uint8_t pinIN2)
{
    ...
    pinMode(_pinIN2, OUTPUT);
      ...
      ledcSetup(_pinEnable, 10000, 8);
      ledcAttachPin(_pinEnable, _pinEnable);
      ledcWrite(_pinEnable, 0);

    // sigmaDeltaSetup(_pinEnable, 5000);
    // sigmaDeltaAttachPin(_pinEnable, _pinEnable);
...
void L298N::forward()
{
    ...
    // sigmaDeltaWrite(_pinEnable, _pwmVal);
...
void L298N::stop()
{
    ...
    // sigmaDeltaWrite(_pinEnable, 255);
